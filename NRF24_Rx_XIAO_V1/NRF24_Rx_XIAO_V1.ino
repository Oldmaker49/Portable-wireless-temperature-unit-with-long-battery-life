...
NOTE: the Transmitter/temperature sender unit measures and transmits the battery voltage as well as the temperature
However: the receiver Unit Code does not in this version display the battery voltage (TO DO)
